...
const Register = () => {
    ...
    if (password.length < 4) {
      errors.push("كلمة المرور يجب ان تكون 4 احرف وما فوق");
    }
    if ((password.match(/[A-Z]/g) || []).length < 1) {
      errors.push("يحب ان تحتوي كلمة المرور على حرف كبير واحد على الأقل");
    }
    if ((password.match(/[^a-z0-9]/gi) || []).length < 1) {
      errors.push("يجب ان تحوي كلمة المرور على رمزا واحداعلى الأقل");
    }
  ...
  return (
    <div className="flex-center p-4 md:p-0 flex-col gap-y-4 md:gap-y-8 h-[100vh] relative">
         ...
         <div className="flex-center gap-x-4">
            ...
            <h1 className="text-white text-2xl font-bold leading-relaxed  ">انشاء حساب</h1>
        </div>
        <div className="flex-center">
            <p className="light-color" >منصة علّمني تهدف لأثراء المحتوى التعليمي بكل ما يحتاجه الطالب</p>
        </div>
